...
difficulty = st.sidebar.selectbox("Select Difficulty Level", ["Easy", "Hard"])
github_link = "my githb link commit"
st.sidebar.markdown(f"[View Code on GitHub]({github_link})")
